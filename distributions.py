...
from finrl_myself.utils import sum_independent_dims
...
# dist = SquashedDiagGaussianDistribution(actions_dim = 29)
# mean_actions = torch.randn(100,29)
# log_std = torch.ones(100,1)/10
# # log_std = torch.tensor(0.1,dtype=torch.float32)
# print(dist.get_actions_log_prob_from_params(mean_actions, log_std)[0])
# print(dist.gaussian_actions)
# print(dist.get_log_prob_from_actions(gaussian_actions = dist.gaussian_actions, mean_actions = mean_actions, log_std = log_std))
...
#             self._prob_distribution(mean_actions, log_std)  # update distribution with new params
#
#         return sum_independent_dims(self.dist.log_prob(gaussian_actions)) # without sampling actions
